  ...
  return (
    <div className="max-w-full lg:max-w-[380px] text-right">
      ...
      <p className="text-xs mt-4 font-semibold hidden md:block">
        ...
        <br />
        crio interfaces interativas com{" "}
        <span className="text-primary100">React</span> e <br />
        sistemas robustos com <span className="text-primary100">
          Java
        </span> e <span className="text-primary100">Spring</span>.
        <br />
